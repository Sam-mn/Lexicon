...
export function NavbarProvider({ children }: INavBarProviderProps): ReactElement {
    ...
    const values: INavbarContext = { navBarName, teacherName, isCourse, NavbarIcon, setNavBarName, setIsCourse, setTeacherName};
